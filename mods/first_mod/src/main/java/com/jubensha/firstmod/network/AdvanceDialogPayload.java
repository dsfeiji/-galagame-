...
public record AdvanceDialogPayload(UUID targetPlayerId, String nextNodeId, int choiceIndex) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, AdvanceDialogPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.INTEGER, AdvanceDialogPayload::choiceIndex,
