...
public record TransitionPayload(boolean blackScreen, String message) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, TransitionPayload> CODEC = PacketCodec.tuple(
            PacketCodecs.BOOL, TransitionPayload::blackScreen,
            PacketCodecs.STRING, TransitionPayload::message,
